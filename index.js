...
let tempSuperheros=superheros;
let publisheruniquedata=[];
document.getElementById('count').innerText=tempSuperheros.length;
...
viewSuperhero=(id)=>{
  ...
  document.getElementById('superhero_weight').innerText=superhero.appearance.weight[1]
  ...
  document.getElementById('superhero_ego').innerText=superhero.biography.alterEgos
  document.getElementById('superhero_firstAppearence').innerText=superhero.biography.firstAppearance
  document.getElementById('superhero_GroupAffliation').innerText=superhero.connections.groupAffiliation
  document.getElementById('superhero_relative').innerText=superhero.connections.relatives
...
display = (superheros) => {
  let superheroString = "";
  superheros.map((superhero, idx) => {
    superheroString += `

        <div class="superhero" >
          <div class="superhero_img">
            <img class="img" src="${superhero.images.sm}" alt="" onclick="viewSuperhero(${superhero.id})">
          </div>
        <div class="superhero_details">
              <h1 class="superhero_name">${superhero.name}</h1>
              <h3 class="bodystats">${superhero.appearance.gender} ${superhero.appearance.height[0]} ${superhero.appearance.weight[1]}
              </h3>
              <div class="powerstats">
                    <div>
                    <p>Intelligence: ${superhero.powerstats.intelligence}</p>
                    <div class='power_bg'>
                    <div class='power_fg' style='width:${superhero.powerstats.intelligence}%;background-color: green;'>
               ...
               <div class='power_bg'>
                    <div class='power_fg' style='width:${superhero.powerstats.speed}%;background-color: red;'>
                ...
                <div class='power_bg'>
                    <div class='power_fg' style='width:${superhero.powerstats.durability}%;background-color: orange;'>
               ...
               <div class='power_bg'>
                    <div class='power_fg' style='width:${superhero.powerstats.power}%; background-color: yellow;'>
               ...
               <div class='power_bg'>
                    <div class='power_fg'style='width:${superhero.powerstats.combat}%;background-color: pink;'>
               ...
               <div>
                ...
                <div class='power_bg'>
                    <div class='power_fg' style='width:${superhero.powerstats.strength}%;background-color: blue;'>
...
display(tempSuperheros)

let publisherfilter=document.getElementById("publisherfilter")
let publisherdata=superheros.map((superhero)=>{
...
for(let i=0;i<publisherdata.length;i++){
    if(publisherdata[i]==null || publisherdata[i]==''){
       continue;
    }
    else if(publisheruniquedata==0 ){
      publisheruniquedata.push(publisherdata[i]);
    }
    else if(publisheruniquedata!==0 &&publisheruniquedata.includes(publisherdata[i])==false){
      publisheruniquedata.push(publisherdata[i])
    }
}
// console.log(publisheruniquedata)

// console.log(publisheruniquedata)
function display_publisher(){
  publisheruniquedata.map((superhero,idx)=>{
    let opt=document.createElement('option');
    if(superhero!==''|| superhero!==null){
    opt.value=`${superhero}`
    opt.innerHTML=`${superhero}`;
    }
...
applyfilter=()=>{
  console.log(filters)
  tempSuperheros=superheros;
  // gender filter logic

  if(filters.gender.active===true){
    tempSuperheros=superheros.filter((superhero,index)=>{
  ...
  if(filters.publisher.active===true){
    ...
    tempSuperheros=tempSuperheros.filter((superhero,index)=>{
  ...
  //name filter logic  ---anywhere in string 
  ...
  //   })
  // }
  //name filter logic -- start with on search bar
  if(filters.name.active===true){
  ...
  // minweight filter logic
  if(filters.minweight.active===true){
    
    tempSuperheros=tempSuperheros.filter((superhero,index)=>{
      if(superhero.appearance.weight[1]!=null){
        // console.log(Number(superhero.appearance.weight[1].split(" ")[0])>=Number(filters.minweight.value))
     return Number(superhero.appearance.weight[1].split(" ")[0])>=Number(filters.minweight.value);
      }
    })
  }
  ...
  if(filters.maxweight.active===true){
    ...
    tempSuperheros=tempSuperheros.filter((superhero,index)=>{
      if(superhero.appearance.weight[1]!=null){
     return Number(superhero.appearance.weight[1].split(" ")[0])<=Number(filters.maxweight.value)
      }
    })
  }
  //intelligence filterlogic
  ...
  // console.log(tempSuperheros)
  display(tempSuperheros)
  document.getElementById('count').innerText=tempSuperheros.length;
}
//cancel filters
 cancelfilter=()=>{
   //reset() work ony for form
...
sorting=()=>{
  //spreadopreadtor use to create a new array by previous one 
  //basically spreadoperator(...) give all the values of array separately i.e. without array example 
  // let a=[1,2,3,4,5]
  //console.log(...a)-----> 1,2,3,4,5
      let sortSuperheros=[...tempSuperheros];
  let property=document.getElementById("sortProperty").value
   let Type=document.getElementById("sortTypeproperty").value
  //  console.log(property,Type)
  if(property!="" && Type!=""){
    sortSuperheros.sort((a,b)=>{
      if(Type==="asc"){
